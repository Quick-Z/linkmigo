...
export const SUPPORTED_URL_MESSAGE = "暂时支持 Instagram、Threads、TikTok、抖音、小红书、快手、视频号、AcFun、Twitter/X、Bilibili、Facebook、Pinterest、Reddit、V2EX、小宇宙、YouTube、Pornhub 的公开链接。";
